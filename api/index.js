...
app.use(
  cors({
    origin: [
      "http://localhost:5173",
      "https://primeshieldsurbiton-frontend.vercel.app",
      "https://primeshieldsurbiton.uk",
      "https://www.primeshieldsurbiton.uk",
    ],
    credentials: true,
  })
);
...
app.get("/", (req, res) => {
  res.send("Prime Shield Services surbiton Backend Server is running");
});

const BRAND_NAME = "Prime Shield Services Surbiton";
